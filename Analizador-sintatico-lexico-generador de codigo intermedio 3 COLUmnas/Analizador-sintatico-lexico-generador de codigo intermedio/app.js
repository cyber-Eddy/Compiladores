...
function traducirCodigo(bloques){
  let respuestas = [];
  let respuesta;
  let i=0;
...
cCodigo.addEventListener('submit', event=>{
  ...
  traducirCodigo(dividirBloque(codigo.value));
  /*   dividirLineas() */
})
